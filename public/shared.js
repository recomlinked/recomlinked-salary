(function() {
  ...
  footer.innerHTML = ''
    ...
    + '<footer class="recomlinked-footer" style="background:#07090f;padding:20px 24px;border-top:1px solid rgba(255,255,255,0.07);font-family:-apple-system,\'Segoe UI\',sans-serif;">'
    ...
    +       '<a href="https://risk.recomlinked.com/about/"          target="_blank" rel="noopener" style="font-size:13px;color:#8a90a8;text-decoration:none;">About</a>'
    +       '<a href="https://risk.recomlinked.com/contact/"        target="_blank" rel="noopener" style="font-size:13px;color:#8a90a8;text-decoration:none;">Contact</a>'
    +       '<a href="https://risk.recomlinked.com/privacy-policy/" target="_blank" rel="noopener" style="font-size:13px;color:#8a90a8;text-decoration:none;">Privacy</a>'
    +     '</div>'
    +   '</div>'
